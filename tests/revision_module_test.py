...
import mnm_repr
import exp_repr
from archive import Archive, AdditionalModels, AcceptedResults
...
#	def test_make_derivative_models_bug_no_refuted_models(self):????
#		rev = RevisionModule('archive')
#		cond_subst_1 = mnm_repr.PresentEntity(mnm_repr.Metabolite('ent_10'), mnm_repr.Medium())
#		cond_subst_2 = mnm_repr.PresentEntity(mnm_repr.Metabolite('ent_21'), mnm_repr.Medium())
#		cond_gene = mnm_repr.PresentEntity(mnm_repr.Gene('ent_31'), mnm_repr.Nucleus())
#		base_model = mnm_repr.Model('m1', [cond_gene], [], [])model that is compatible with interventions
##		second_mod = mnm_repr.Model('deriv_m1_0', [cond_subst_1, cond_subst_2], [], [])
##		third_mod = mnm_repr.Model('deriv_m1_1', [], [], [])

#		exd1 = exp_repr.ExperimentDescription(exp_repr.DetectionEntity(mnm_repr.Metabolite('ent_10')), [mnm_repr.Remove(cond_gene)])
#		exd2 = exp_repr.ExperimentDescription(exp_repr.DetectionEntity(mnm_repr.Metabolite('ent_21')), [mnm_repr.Remove(cond_gene)])
#		res1 = exp_repr.Result('r1', exd1, True)
#		res2 = exp_repr.Result('r2', exd2, True)
#		extracted_results = [res1, res2] need interventions in description
